      ...
      <div className="bg-[#056968] rounded-full shadow-lg flex justify-around items-center py-4 px-6">
        ...
        {currentUser ? (
          <Link href="/hospitalsearch">
            <button className="flex flex-col items-center cursor-pointer  text-[#edb13b] hover:text-white transition-colors duration-300 transform hover:-translate-y-1">
              <FaSearch size={20} />
        ...
        {currentUser ? (
          ...
          <Link href="/authpage">
            <button className="flex flex-col items-center cursor-pointer  text-[#edb13b] hover:text-white transition-colors duration-300 transform hover:-translate-y-1">
              <FaPlay size={20} />
              <span className="text-xs mt-1">Get Start</span>
            </button>
          </Link>
        )}
        ...
        {currentUser ? (
          ...
          <Link href="/authpage">
            <button className="flex flex-col items-center text-[#edb13b] cursor-pointer   hover:text-white transition-colors duration-300 transform hover:-translate-y-1">
              <FaExclamationTriangle size={20} />
              <span className="text-xs mt-1">Emergency</span>
            </button>
          </Link>
