    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6 pt-24">
      <div className="max-w-6xl mx-auto">
        <header className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-indigo-800 mb-4">Home Care Services</h1>
        ...
        {/* Service Providers */}
        <div>
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Available Care Providers</h2>

          {filteredProviders.length === 0 ? (
            <div className="text-center p-8 bg-white rounded-lg shadow">
              <p className="text-gray-500">No providers match your criteria. Please try different filters.</p>
            </div>
          ) : (
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {provider.services.map(serviceId => {
                        ...
                        return service ? (
                          <span key={serviceId} className="bg-indigo-100 text-indigo-800 text-xs px-2 py-1 rounded">
                            {service.name}
                          </span>
                        ) : null;
                      })}
