...
// Define page props to get the hospital ID from the URL
interface PageProps {
    params: {
        id: string;
    }
...
export default function HospitalDetailPage({ params }: PageProps) {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <Link href="/providers" className="inline-flex items-center text-blue-600 hover:text-blue-800 mb-6">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-6">
                    <h1 className="text-2xl font-bold text-gray-800 mb-4">{hospital.name}</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            ...
                            {hospital.phone && (
                                <div className="flex items-start">
                                    <Phone className="h-5 w-5 mr-2 text-blue-500 flex-shrink-0 mt-0.5" />
                                    <div>
                                        <p className="font-medium text-gray-700">Phone</p>
                                        <p className="text-gray-600">{getPhoneDisplay(hospital.phone)}</p>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                            <h2 className="text-lg font-semibold text-gray-700 mb-3">Hospital ID</h2>
                            <p className="text-xl font-bold text-blue-600">{hospital.sno}</p>
                            <p className="text-gray-500 text-sm mt-1">Reference number</p>
                        </div>
                    </div>
                </div>
            </div>
