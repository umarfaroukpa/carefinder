                        ...
                        <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2">
                                    <label htmlFor="doctor" className="block text-gray-700 font-medium mb-2">Preferred Doctor (Optional)</label>
                                    <input
                                        type="text"
                                        id="doctor"
                                        name="doctor"
                            ...
                            <div className="mt-8 text-center">
                                <button
                                    ...
                                    className="bg-[#056968] hover:bg-[#045857] text-white font-medium py-3 px-8 rounded-md transition duration-300 ease-in-out"
                                >
