    ...
    <div className="bg-gray-100 pt-24 min-h-screen py-12">
      <div className="container mx-auto px-4">
        <section className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[#056968] mb-4">Contact Us</h1>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-semibold text-[#056968] mb-4">Get in Touch</h2>
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <p className="text-[#056968]">Kaduna, North West Region, Nigeria</p>
              </div>
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="mailto:info@carefinder.com" className="text-[#056968] hover:text-[#edb13b]">
                  info@carefinder.com
                </a>
              </div>
              <div className="flex items-center">
                ...
                <p className="text-[#056968]">+234 123 456 7890</p>
              </div>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-semibold text-[#056968] mb-4">Send Us a Message</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-[#056968]">
                  Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-[#056968]">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-[#056968]">
                  Message
                </label>
                <textarea
                  id="message"
        ...
        <section className="text-center">
          <h2 className="text-2xl md:text-3xl font-semibold text-[#056968] mb-4">Our Location</h2>
          <div className="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
            <p className="text-[#056968] mb-4">Kaduna, North West Region, Nigeria</p>
